...
Based on [Wikipedia's list of programming languages](https://en.wikipedia.org/wiki/List_of_programming_languages), this repository lists all valid programming languages which can be used in coding style language format field.
